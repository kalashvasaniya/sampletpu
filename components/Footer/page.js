          ...
          <div className="sm:flex sm:items-center sm:justify-between ">
            ...
            <div className="hidden md:block">
              <div className="text-base text-white flex flex-row space-x-10">
                ...
                {/* buttons  */}
                <div class="flex mx-auto items-center space-x-4">
                  <button onClick={() => {
                    alert("Coming Soon, Stay tuned to be a part of it.")
                  }} class="bg-sky-500 inline-flex py-2 px-4 rounded-lg items-center hover:scale-105 focus:outline-none">
                    ...
                    <span class="ml-4 flex items-start flex-col leading-none">
                      <span class="text-xs text-gray-100 mb-1">GET IT ON</span>
